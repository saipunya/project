...
<div class="row g-3 mb-3">
    <div class="col-md-6">
        <div class="card h-100">
            <div class="card-body">
                <h5>Budget Usage</h5>
                <p>Total Allocated: <strong><?= number_format((float) $summary['budget']['total_allocated'], 2) ?></strong></p>
                <p>Total Used: <strong><?= number_format((float) $summary['budget']['total_used'], 2) ?></strong></p>
            </div>
        </div>
    </div>
    <div class="col-md-6">
