<div class="container mt-4">
    <div class="row align-items-center mb-4">
        <div class="col-lg-8">
            <h1 class="display-6 fw-bold">กิจกรรม</h1>
            <p class="text-muted mb-0">จัดการกิจกรรมในแต่ละโครงการอย่างเป็นระบบ</p>
        </div>
    </div>

    <div class="card mb-4 bg-panel">
        <div class="card-body">
            <h5 class="card-title mb-3">สร้างกิจกรรมใหม่</h5>
            <form method="POST" action="/activities" class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input class="form-control" type="text" name="name" placeholder="ชื่อกิจกรรม" required>
                </div>
                <div class="col-md-2">
    ...
    <div class="card bg-panel">
        <div class="card-body">
            <h5 class="card-title mb-3">รายการกิจกรรม</h5>
